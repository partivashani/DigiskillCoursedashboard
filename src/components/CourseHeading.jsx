...
<section className="bg-gray-900 text-white p-5">
     ...
     return <div className="flex flex-col lg:flex-row gap-20 justify-center max-w-full mx-auto  items-center p-2 border-red-500 border-2 mt-2">


  {/* Left Section - Course Details */}
    <div className="flex-1 bg-gray-800 p-6 rounded-lg shadow-lg max-w-4xl">

      <div className="flex justify-start items-center gap-1 mb-2 "><CiHome className="text-red-500 " /><a href="" className=" text-blue-500 font-semibold">Home  </a><FaGreaterThan /><span className="font-thin">{data.title}</span></div>
